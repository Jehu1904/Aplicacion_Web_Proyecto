/**
 * @file modulo-react/src/services/api.ts
 * @description Servicio API con token compartido para Supabase
 * Implementa el patrón del PDF: lectores del token localStorage
 */
